# Cinco Requisitos Funcionais dos usuários clientes da empresa. 
...
**RF008 Descrição**
O usuário prestador de serviço, quando presenciar uma conduta indevida do usuário cliente, pode denunciar-lo na própria plataforma da empresa.
